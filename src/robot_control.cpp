...
public:
    ...
    void configureMovement() {
        ...
        move_group_.setGoalJointTolerance(0.02);  // 0.02 radians tolerance for joints
        move_group_.setGoalPositionTolerance(0.002);  // 2mm position tolerance
        move_group_.setGoalOrientationTolerance(0.02);  // 0.02 radians orientation tolerance
