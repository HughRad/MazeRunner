 ...
 */
 ...
 private:
     ...
     /** 
      * @brief Coordinate pair (row, column) representing the start position 
      */
    std::pair<int, int> start;
    
     /** 
      * @brief Vector of coordinate pairs representing all exit positions 
      */
    std::vector<std::pair<int, int>> exits;
    
     /** 
      * @brief The selected exit position that is closest to the start 
      */
    std::pair<int, int> closest_exit;
